...
.. automodule:: HALF.Strategies
   :members:
   :undoc-members:
   :show-inheritance:


HALF.Strategies.wrap\_distil\_util
-----------------------------------------

Strategies from the :doc:`Distil <distil:ActStrategy/distil.active_learning_strategies>` library
`````````````````````````````````````````````````````````````````````````````````````````````````

- :py:class:`AdversarialBIM <distil.active_learning_strategies.adversarial_bim.AdversarialBIM>`
...
- :py:class:`FASS <distil.active_learning_strategies.fass.FASS>` 
...
CoreGCN
--------
.. automodule:: HALF.Strategies.sequence_gcn.CoreGCN
   :members:
   :undoc-members:
   :show-inheritance:
...
UncertainGCN
------------
.. automodule:: HALF.Strategies.sequence_gcn.UncertainGCN
   :members:
   :undoc-members:
   :show-inheritance: